...
<head>
  ...
  <title><?php echo $siteName; ?> - Removed List</title>
...
<table id="example1" class="table table-bordered table-striped">
    ...
    <tbody>
        ...
        // Query the "people" table to retrieve the desired columns, including the "reason" column, for users where either blocked or defriended is set to "True"
        $query = "SELECT displayname, gender, first_name, date_of_birth, date_of_added, friend_group, reason, id FROM people WHERE blocked = 'True' OR defriended = 'True'";
